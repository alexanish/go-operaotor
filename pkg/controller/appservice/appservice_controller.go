...
import (
	...
	//shailendra14kv1alpha1 "github.com/shailendra14k/appservice-operator/pkg/apis/shailendra14k/v1alpha1"
	appv1alpha1 "github.com/alexanish/go-operator/pkg/apis/app/v1alpha1"
...
func (r *ReconcileAppService) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	err := r.client.Get(context.TODO(), request.NamespacedName, appservice)
	if err != nil {
	...
	err = r.client.Get(context.TODO(), types.NamespacedName{Name: appservice.Name, Namespace: appservice.Namespace}, found)
	...
	if err = r.client.List(context.TODO(), podList, listOpts...); err != nil {
		reqLogger.Error(err, "Failed to list pods", "AppService.Namespace", appservice.Namespace, "AppService.Name", appservice.Name)
		return reconcile.Result{}, err
	}
	...
	if !reflect.DeepEqual(podNames, appservice.Status.Nodes) {
		...
		err := r.client.Status().Update(context.TODO(), appservice)
		if err != nil {
...
func (r *ReconcileAppService) deploymentForAppService(m *appv1alpha1.AppService) *appsv1.Deployment {
